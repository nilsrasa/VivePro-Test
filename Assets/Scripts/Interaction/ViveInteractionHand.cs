...
public class ViveInteractionHand : InteractionController
{
    #region Inspector
    ...
    private InteractionHand.BoneMapFunc[] _handContactBoneMapFunctions;
    ...
    private void initContactBones()
    {
        ...
        _handContactBoneMapFunctions = new InteractionHand.BoneMapFunc[NUM_FINGERS * BONES_PER_FINGER + 1];
